...
namespace nanomap{
  namespace handler{
    ...
    class Handler{
      public:
        Handler(std::shared_ptr<nanomap::config::Config> config);

        void populateTempGrid(openvdb::FloatGrid::Accessor& tempAcc, int sensorIndex, int pcl_width, int pcl_height, int pcl_step,
        ...
        void processPointCloudCPU(int index, int pcl_width, int pcl_height, int pcl_step, unsigned char* cloud,  std::shared_ptr<nanomap::map::Map> map);
        ...
        void processPointCloud(int sensorIndex, int pcl_width, int pcl_height,
